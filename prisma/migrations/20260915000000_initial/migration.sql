...
-- CreateEnum
CREATE TYPE "StaffSubrole" AS ENUM ('KITCHEN_STAFF', 'CASHIER', 'MANAGER');
...
-- CreateEnum
CREATE TYPE "RushLevel" AS ENUM ('LOW', 'MODERATE', 'BUSY', 'VERY_BUSY');
...
CREATE TABLE "StaffProfile" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "subrole" "StaffSubrole" NOT NULL DEFAULT 'KITCHEN_STAFF',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "MenuItem_totalOrdered_idx" ON "MenuItem"("totalOrdered");
