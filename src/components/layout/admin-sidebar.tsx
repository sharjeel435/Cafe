  ...
  const NavContent = () => (
    <>
      <div className="p-4 border-b border-gray-200 mb-2">
        ...
        <div className="text-xs text-gray-500 mt-1 ml-10">Admin Console</div>
      </div>
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 inset-x-0 z-40 bg-white border-b border-gray-200 h-14 flex items-center px-4 justify-between">
        ...
        <button onClick={() => setMobileOpen(!mobileOpen)} className="p-2 text-gray-600 hover:bg-gray-100 rounded-xl">
